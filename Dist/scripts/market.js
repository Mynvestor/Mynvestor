    ...
    indexCard += `
        <div class="col-md-4 col-xl-4 mb-1 ">
            <div class="portfolio-summary">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <small class="d-block"><i class="bi bi-wallet me-1"></i>Value</small>
                        <span class="fw-bold">${item.indexValue}</span>
                    </div>
                    <div class="col-md-4">
                        <small class="d-block"><i class="bi bi-cash-stack me-1"></i>Volume</small>
                        <span class="fw-bold text-success">${item.indexVolume}</span>
                    </div>
                    <div class="col-md-4">
                        <small class="d-block"><i class="bi bi-graph-up me-1"></i>Unique Trades</small>
